  ...
  const experiences: Experience[] = [
    {
      ...
      position: "Software Engineer/Three.JS Developer",
      duration: "2025 - Present",
      period: "Current",
      description: [
        "Developed interactive 3D web experiences using Three.js, React Three Fiber, and GLSL",
        "Engineered responsive interfaces with Next.js, TypeScript, and Tailwind CSS",
        "Integrated backend services with Supabase and REST APIs for dynamic content",
        "Collaborated in agile environments with code reviews and iterative improvements",
      ],
      skills: ["Three.js", "React Three Fiber", "Next.js", "TypeScript", "Supabase"],
      current: true,
    },
    {
      id: 2,
